...
from src.utilities import data_loaders_utils, gmic_utils
from src.train_eval import test
from src.analysis import mask_roi_match, imagelabel_attwt_match
...
def visualize_example(config_params, input_img_case, saliency_maps_case, true_segs,
    ...
    """
    Function that visualizes the Atten maps for an example
    """
