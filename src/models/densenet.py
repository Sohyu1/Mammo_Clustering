...
def _densenet(
    ...
    **kwargs: Any,
    ...
    if kwargs['activation']=='softmax':
        model = DenseNet(growth_rate, block_config, num_init_features,num_classes=2, **kwargs)
    elif kwargs['activation']=='sigmoid':
        model = DenseNet(growth_rate, block_config, num_init_features,num_classes=1, **kwargs)
