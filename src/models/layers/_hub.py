...
from src.models.layers._pretrained import filter_pretrained_cfg
...
def save_config_for_hf(
    ...
    if label_names:
        ...
        # CNN label id (classifier index) -> unique label name (ie synset for ImageNet, MID for OpenImages)
