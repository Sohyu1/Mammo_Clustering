...
__all__ = ['MyResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152']
...
class MyResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=2, zero_init_residual=False, groups=1, width_per_group=64,
        ...
        self.conv1 = nn.Conv2d(1, self.inplanes, kernel_size=7, stride=2, padding=1, bias=False)
        ...
        if self.activation == 'softmax':
            ...
            self.conv3 = nn.Conv2d(192, 1, kernel_size=1, stride=1, padding=0, bias=False)
...
def resnet18_features(pretrained=False, progress=True, **kwargs):
...
def resnet34_features(pretrained=False, progress=True, **kwargs):
...
def resnet50_features(pretrained=False, progress=True, **kwargs):
...
def resnet101_features(pretrained=False, progress=True, **kwargs):
...
def resnet152_features(pretrained=False, progress=True, **kwargs):
