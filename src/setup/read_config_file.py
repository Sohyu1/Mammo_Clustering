...
def read_config_file(config_file):
    ...
    config_params['batchsize'] = int(config_object['parametersetting']['batchsize'])
    ...
    config_params['viewsinclusion'] = config_object["parametersetting"][
        'viewsinclusion']  # -> from data to viewsinclusion
    ...
    config_params['patienceepochs'] = config_object["parametersetting"]['patienceepochs']
    ...
    config_params['MIL_csvfilepath'] = config_object["parametersetting"][
        'MIL_csvfilepath']  # "/homes/spathak/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_biradscombined_breastdensityadded_patientinfoadded_final4.csv"
    if config_params['MIL_csvfilepath'] == 'False':
        config_params['MIL_csvfilepath'] = False
    config_params['DS_csvfilepath'] = config_object["parametersetting"]['DS_csvfilepath']
    if config_params['DS_csvfilepath'] == 'False':
        config_params['DS_csvfilepath'] = False
    ...
    if config_params['femodel'] == 'gmic_resnet18' or config_params['femodel'] == 'gmic':
