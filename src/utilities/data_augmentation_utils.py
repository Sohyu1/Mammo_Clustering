...
def data_augmentation_train_kim(config_params, mean, std_dev):
    preprocess_train = transforms.Compose([
        ...
        transforms.Resize((config_params['resize'][0], config_params['resize'][1]), antialias=True),
        transforms.ToTensor(),
...
def data_augmentation_train_shen_gmic(config_params, mean, std_dev):
    ...
    if config_params['imagecleaning'] != 'gmic':
        if config_params['resize']:
            preprocess_train_list.append(transforms.Resize((config_params['resize'][0], config_params['resize'][1]), antialias=True))
...
def data_augmentation_test_shen_gmic(config_params, mean, std_dev):
    ...
    if config_params['imagecleaning'] != 'gmic':
        if config_params['resize']:
            preprocess_test_list.append(transforms.Resize((config_params['resize'][0], config_params['resize'][1]), antialias=True))
