...
from src.utilities import data_augmentation_utils, augmentations_funcfromgmic
...
def load_image(image_path, view, horizontal_flip, breast_side):
    ...
    image = data_augmentation_utils.myhorizontalflip(image, breast_side)
    return image
...
def gmic_image_cleaning(image, view, best_center):
    ...
    """
    cropped_image, _ = augmentations_funcfromgmic.random_augmentation_best_center(
        image=image,
